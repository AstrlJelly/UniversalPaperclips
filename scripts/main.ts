...
function adjustWirePrice(){
    ...
    if (Math.random() < .015) {
        ...
        document.getElementById("wireCost").innerHTML = wireCost.toString();
    }
}
...
class QChips
{
    ...
    value: number;
    active: number;
    constructor(waveSeed : number, value : number, active : number) {
...
function quantumCompute(){
    ...
    for (let i = 0; i<qChips.length; i++){
        ...
        document.getElementById("qChip"+i).style.opacity = qChips[i].value.toString();
    }
}
...
function displayProjects(project: Project){
    ...
    newProject.appendChild(element.firstChild);
...
function longBlink(elemID: string){
    ...
    // {
    let handle = setInterval(function(){longToggleVisibility(elemID)}, 32);
    // }
...
function blink(elemID: string){
    ...
    // {
    let handle = setInterval(function(){toggleVisibility(elemID)}, 30);
    // }
...
if (honor<maxTrustCost){(document.getElementById("btnIncreaseMaxTrust") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnIncreaseMaxTrust") as HTMLButtonElement).disabled = false;
            }

if (unusedClips<probeCost){(document.getElementById("btnMakeProbe") as HTMLButtonElement).disabled = true;
            } else {
...
if (wire<1){(document.getElementById("btnMakePaperclip") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnMakePaperclip") as HTMLButtonElement).disabled = false;
            }
if (funds<wireCost){(document.getElementById("btnBuyWire") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnBuyWire") as HTMLButtonElement).disabled = false;
            }
if (funds<clipperCost){(document.getElementById("btnMakeClipper") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnMakeClipper") as HTMLButtonElement).disabled = false;
            }
if (funds<adCost){(document.getElementById("btnExpandMarketing") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnExpandMarketing") as HTMLButtonElement).disabled = false;
            }
if (margin<=.01){(document.getElementById("btnLowerPrice") as HTMLButtonElement).disabled = true;
            } else {
...
if (funds<megaClipperCost){(document.getElementById("btnMakeMegaClipper") as HTMLButtonElement).disabled = true;
            } else {
...
if (unusedClips<factoryCost){(document.getElementById("btnMakeFactory") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnMakeFactory") as HTMLButtonElement).disabled = false;
            }


if (harvesterLevel==0){(document.getElementById("btnHarvesterReboot") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnHarvesterReboot") as HTMLButtonElement).disabled = false;
            }

if (wireDroneLevel==0){(document.getElementById("btnWireDroneReboot") as HTMLButtonElement).disabled = true;
            } else {
            (document.getElementById("btnWireDroneReboot") as HTMLButtonElement).disabled = false;
            }

if (factoryLevel==0){(document.getElementById("btnFactoryReboot") as HTMLButtonElement).disabled = true;
            } else {
...
document.getElementById("probeTrustUsedDisplay").innerHTML = probeUsedTrust.toString();

if (yomi < probeTrustCost || probeTrust >= maxTrust) {(document.getElementById("btnIncreaseProbeTrust") as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnIncreaseProbeTrust") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeSpeed") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeSpeed") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeSpeed < 1) {((document.getElementById("btnLowerProbeSpeed") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeSpeed") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeNav") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeNav") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeNav < 1) {((document.getElementById("btnLowerProbeNav") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeNav") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeRep") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeRep") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeRep < 1) {((document.getElementById("btnLowerProbeRep") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeRep") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeHaz") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeHaz") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeHaz < 1) {((document.getElementById("btnLowerProbeHaz") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeHaz") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeFac") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeFac") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeFac < 1) {((document.getElementById("btnLowerProbeFac") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeFac") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeHarv") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeHarv") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeHarv < 1) {((document.getElementById("btnLowerProbeHarv") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeHarv") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeWire") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeWire") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeWire < 1) {((document.getElementById("btnLowerProbeWire") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeWire") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeTrust - probeUsedTrust < 1) {((document.getElementById("btnRaiseProbeCombat") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnRaiseProbeCombat") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}

if (probeCombat < 1) {((document.getElementById("btnLowerProbeCombat") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {((document.getElementById("btnLowerProbeCombat") as HTMLButtonElement) as HTMLButtonElement).disabled = false;}
...
function investUpgrade(){
    ...
    investLevel++;
    document.getElementById("investmentLevel").innerHTML=investLevel.toString();
...
for (let i = 1; i<=portfolioSize; i++){
    ...
    document.getElementById("stock"+n+"Amount").innerHTML = Math.ceil(stocks[s].amount).toString();
    document.getElementById("stock"+n+"Price").innerHTML = Math.ceil(stocks[s].price).toString();
    document.getElementById("stock"+n+"Total").innerHTML = Math.ceil(stocks[s].total).toString();
    document.getElementById("stock"+n+"Profit").innerHTML = Math.ceil(stocks[s].profit).toString();
}
...
let tourneyLvl = 1;
let choiceANames = ["cooperate", "swerve", "macro", "fight", "bet", "raise_price", "opera", "go", "heads", "particle", "discrete", "peace", "search", "lead", "accept", "accept", "attack"];
let choiceBNames = ["defect", "straight", "micro", "back_down", "fold", "lower_price", "football", "stay", "tails", "wave", "continuous", "war", "evaluate", "follow", "reject", "deny", "decay"];
let stratCounter = 0;
let roundNum = 0;
let hMove = 1;
let vMove = 1;
...
((document.getElementById("btnRunTournament") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
...
function whatBeatsLast(myPos: number){
    let oppsPos = 1;
    if (myPos == 1){
        oppsPos = 2;
    } else {
...
function generateGrid(){
    ...
    document.getElementById("aaPayoffH").innerHTML = payoffGrid.valueAA.toString();
    document.getElementById("aaPayoffV").innerHTML = payoffGrid.valueAA.toString();
    document.getElementById("abPayoffH").innerHTML = payoffGrid.valueAB.toString();
    document.getElementById("abPayoffV").innerHTML = payoffGrid.valueBA.toString();
    document.getElementById("baPayoffH").innerHTML = payoffGrid.valueBA.toString();
    document.getElementById("baPayoffV").innerHTML = payoffGrid.valueAB.toString();
    document.getElementById("bbPayoffH").innerHTML = payoffGrid.valueBB.toString();
    document.getElementById("bbPayoffV").innerHTML = payoffGrid.valueBB.toString();
}
...
function newTourney(){
    ...
    ((document.getElementById("btnRunTournament") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
...
function calcPayoff(hm: number, vm: number){
    if (hm==1 && vm==1){
...
function round(roundNum: number){
    roundSetup();
    roundLoop();
...
function updateDronePrices(){
    ...
    if (unusedClips<harvesterCost){((document.getElementById("btnMakeHarvester") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnMakeHarvester") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<p10h){((document.getElementById("btnHarvesterx10") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnHarvesterx10") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<p100h){((document.getElementById("btnHarvesterx100") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnHarvesterx100") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<p1000h){((document.getElementById("btnHarvesterx1000") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnHarvesterx1000") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<wireDroneCost){((document.getElementById("btnMakeWireDrone") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
                } else {
                ((document.getElementById("btnMakeWireDrone") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
                }

    if (unusedClips<p10w){((document.getElementById("btnWireDronex10") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
                } else {
                ((document.getElementById("btnWireDronex10") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
                }

    if (unusedClips<p100w){((document.getElementById("btnWireDronex100") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
                } else {
                ((document.getElementById("btnWireDronex100") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
                }

    if (unusedClips<p1000w){((document.getElementById("btnWireDronex1000") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
                } else {
                ((document.getElementById("btnWireDronex1000") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
                }
...
function updateSwarm(){
    ...
    if (yomi<synchCost){((document.getElementById("btnSynchSwarm") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnSynchSwarm") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (creativity<entertainCost){((document.getElementById("btnEntertainSwarm") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnEntertainSwarm") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }
...
function updatePower(){
    ...
    if (unusedClips<farmCost){((document.getElementById("btnMakeFarm") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnMakeFarm") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<batteryCost){((document.getElementById("btnMakeBattery") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnMakeBattery") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (farmLevel<1){((document.getElementById("btnFarmReboot") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnFarmReboot") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (batteryLevel<1){((document.getElementById("btnBatteryReboot") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnBatteryReboot") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<p10f){((document.getElementById("btnFarmx10") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnFarmx10") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<p100f){((document.getElementById("btnFarmx100") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnFarmx100") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<p10b){((document.getElementById("btnBatteryx10") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnBatteryx10") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }

    if (unusedClips<p100b){((document.getElementById("btnBatteryx100") as HTMLButtonElement) as HTMLButtonElement).disabled = true;
            } else {
            ((document.getElementById("btnBatteryx100") as HTMLButtonElement) as HTMLButtonElement).disabled = false;
            }
...
function buyAds(){
    if(funds >= adCost){
        ...
        document.getElementById('funds').innerHTML = funds.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
        document.getElementById('marketingLvl').innerHTML = marketingLvl.toString();
    }
}
...
function addProc(){
        ...
        document.getElementById("processors").innerHTML = processors.toString();
        if (creativityOn){
...
function addMem(){
        ...
        memory=memory+1;
        document.getElementById("memory").innerHTML = memory.toString();
...
function numberCruncher(number : number, decimals : number = undefined){
    ...
    let numberTypes : string[] = [
        ...
        "quindecillion", "sexdecillion", "sepdecillion"
    ]
...
function increaseProbeTrust(){
    ...
    document.getElementById('probeTrustDisplay').innerHTML = probeTrust.toString();
...
function raiseProbeSpeed(){
    ...
    probeSpeed++;
    document.getElementById('probeSpeedDisplay').innerHTML = probeSpeed.toString();
}
...
function raiseProbeNav(){
    probeNav++;
    document.getElementById('probeNavDisplay').innerHTML = probeNav.toString();
}
...
function raiseProbeHaz(){
    probeHaz++;
    document.getElementById('probeHazDisplay').innerHTML = probeHaz.toString();
}
...
function raiseProbeRep(){
    probeRep++;
    document.getElementById('probeRepDisplay').innerHTML = probeRep.toString();
}
...
function raiseProbeFac(){
    probeFac++;
    document.getElementById('probeFacDisplay').innerHTML = probeFac.toString();
}
...
function raiseProbeHarv(){
    probeHarv++;
    document.getElementById('probeHarvDisplay').innerHTML = probeHarv.toString();
}
...
function raiseProbeWire(){
    probeWire++;
    document.getElementById('probeWireDisplay').innerHTML = probeWire.toString();
}
...
function raiseProbeCombat(){
    probeCombat++;
    document.getElementById('probeCombatDisplay').innerHTML = probeCombat.toString();
}
...
if (dismantle >= 5) {
   ...
   for (let i = 0; i<qChips.length; i++){
    ...
    if (endTimer4==10){
        wire = wire+1;
        document.getElementById("transWire").innerHTML = wire.toString();
    }
...
//    acquiredMatter = 0;
    ...
    document.getElementById('availableMatterDisplay').innerHTML = numberCruncher(availableMatter);
    document.getElementById("honorDisplay").innerHTML = Math.round(honor).toLocaleString();
    document.getElementById('clipmakerLevel2').innerHTML = clipmakerLevel.toString();
    document.getElementById('clipperCost').innerHTML = clipperCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
    document.getElementById('acquiredMatterDisplay').innerHTML = numberCruncher(acquiredMatter);
    document.getElementById('nanoWire').innerHTML = numberCruncher(wire);
    document.getElementById('probesBornDisplay').innerHTML = numberCruncher(probeDescendents);
    document.getElementById('probesTotalDisplay').innerHTML = numberCruncher(probeCount);
    document.getElementById('probesLaunchedDisplay').innerHTML = probeLaunchLevel.toString();
    document.getElementById('probeCostDisplay').innerHTML = numberCruncher(probeCost);
    document.getElementById('probeCombatDisplay').innerHTML = probeCombat.toString();
    document.getElementById('probeWireDisplay').innerHTML = probeWire.toString();
    document.getElementById('probeHarvDisplay').innerHTML = probeHarv.toString();
    ...
    document.getElementById('adCost').innerHTML = adCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
    document.getElementById('factoryCostDisplay').innerHTML = numberCruncher(factoryCost);
    document.getElementById('factoryLevelDisplay').innerHTML = factoryLevel.toString();
    document.getElementById("unusedClipsDisplay").innerHTML = numberCruncher(unusedClips);
    document.getElementById('wireDroneCostDisplay').innerHTML = numberCruncher(wireDroneCost);
    document.getElementById('wireDroneLevelDisplay').innerHTML = wireDroneLevel.toString();
    document.getElementById('harvesterCostDisplay').innerHTML = numberCruncher(harvesterCost);
    document.getElementById('harvesterLevelDisplay').innerHTML = harvesterLevel.toString();
    document.getElementById('megaClipperCost').innerHTML = megaClipperCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
    document.getElementById('megaClipperLevel').innerHTML = megaClipperLevel.toString();
    document.getElementById('investmentBankroll').innerHTML = bankroll.toLocaleString();
    document.getElementById('secValue').innerHTML = secTotal.toLocaleString();
    document.getElementById('portValue').innerHTML = portTotal.toLocaleString();
    document.getElementById("investUpgradeCost").innerHTML=investUpgradeCost.toLocaleString();
    document.getElementById("yomiDisplay").innerHTML=yomi.toLocaleString();
    document.getElementById("investmentLevel").innerHTML=investLevel.toString();
    document.getElementById("prestigeUcounter").innerHTML= (prestigeU + 1).toString();
    document.getElementById("prestigeScounter").innerHTML= (prestigeS + 1).toString();
