...
class Project
{
    ...
    flag : number;
    effect : Function;
    constructor(id: string, title: string, priceTag: string, description: string, trigger: Function, uses: number, cost: Function, flag: number, effect: Function)
    {
        this.id = id;
        this.title = title;
...
let project1 = {
    ...
    effect: function(){
        ...
        let index = activeProjects.indexOf(project1);
...
let project2 = {
    ...
    effect: function() {
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project2);
        activeProjects.splice(index, 1);
    }
}
...
let project3 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project3);
        activeProjects.splice(index, 1);
    }
}
...
let project4 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project4);
        activeProjects.splice(index, 1);
    }
}
...
let project5 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project5);
        activeProjects.splice(index, 1);
    }
}
...
let project6 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project6);
        activeProjects.splice(index, 1);
    }
}
...
let project7 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project7);
        activeProjects.splice(index, 1);
    }
}
...
let project8 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project8);
        activeProjects.splice(index, 1);
    }
}
...
let project9 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project9);
        activeProjects.splice(index, 1);
    }
}
...
let project10 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project10);
        activeProjects.splice(index, 1);
    }
}
...
let project10b = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project10b);
        activeProjects.splice(index, 1);
    }
}
...
let project28 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project28);
        activeProjects.splice(index, 1);
    }
}
...
let project29 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project29);
        activeProjects.splice(index, 1);
    }
}
...
let project30 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project30);
        activeProjects.splice(index, 1);
    }
}
...
let project31 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project31);
        activeProjects.splice(index, 1);
    }
}
...
let project37 = {
    ...
    effect: function(){
        ...
        trust = trust + 1;
        document.getElementById("demand").innerHTML = demand.toString();
        funds = funds - 1000000;
...
let project38 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project38);
        activeProjects.splice(index, 1);
    }
}
...
let project42 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project42);
        activeProjects.splice(index, 1);
    }
}
...
let project43 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project43);
        activeProjects.splice(index, 1);
    }
}
...
let project44 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project44);
        activeProjects.splice(index, 1);
    }
}
...
let project45 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project45);
        activeProjects.splice(index, 1);
    }
}
...
let project40 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project40);
        activeProjects.splice(index, 1);
    }
}
...
let project50 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project50);
        activeProjects.splice(index, 1);
    }
}
...
let project51 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project51);
        activeProjects.splice(index, 1);
    }
}
...
let project60 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project60);
        activeProjects.splice(index, 1);
    }
}
...
let project61 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project61);
        activeProjects.splice(index, 1);
    }
}
...
let project62 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project62);
        activeProjects.splice(index, 1);
    }
}
...
let project63 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project63);
        activeProjects.splice(index, 1);
    }
}
...
let project64 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project64);
        activeProjects.splice(index, 1);
    }
}
...
let project65 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project65);
        activeProjects.splice(index, 1);
    }
}
...
let project66 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project66);
        activeProjects.splice(index, 1);
    }
}
...
let project147 = {
    ...
    effect: function(){
        ...
        element.parentNode.removeChild(element);
        let element = document.getElementById("projectButton148");
        element.parentNode.removeChild(element);
        let index = activeProjects.indexOf(project147);
        activeProjects.splice(index, 1);
        let index = activeProjects.indexOf(project148);
        activeProjects.splice(index, 1);
    }
}
...
let project215 = {
    ...
    trigger: () => project214.flag == 1 && endTimer4 >= 300,
    uses: 1,
...
let project218 = {
    ...
    trigger: () => creativity >= 1000000,
    uses: 1,
    cost: () => creativity >= 1000000,
    flag: 0,
    effect: function(){
        creativity -= 1000000;
        project218.flag = 1;
