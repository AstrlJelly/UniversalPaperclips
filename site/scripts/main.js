...
function displayMessage(msg){
    if (lastMessage === msg) {
        ...
        for (let i = consoleDiv.childNodes.length - 1; i >= 2; i--) {
            console.log("consoleDiv.childNodes[i - 1].innerHTML : " + consoleDiv.childNodes[i - 1].innerHTML);
            console.log("consoleDiv.childNodes[i].innerHTML : " + consoleDiv.childNodes[i].innerHTML);
            consoleDiv.childNodes[i - 1].innerHTML = consoleDiv.childNodes[i].innerHTML;
        }
